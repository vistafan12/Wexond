      ...
      <div>
        <div ref='titlebar' style={{
          ...
          <div className='titlebar-controls'>
            <div className='titlebar-control' style={minimizeStyle} onClick={this.props.getApp().minimizeOrRestore} />
            <div className='titlebar-control' style={maximizeStyle} onClick={this.props.getApp().maximizeOrRestore} />
            <div className='titlebar-control' style={closeStyle} onClick={this.props.getApp().close} />
          </div>
