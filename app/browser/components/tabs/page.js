...
export default class Page extends React.Component {
    ...
    */
    componentDidMount() {
        ...
        webview.addEventListener('found-in-page', this.onFoundInPage);
    ...
    onIpcMessage = (e) => {
        ...
        if (e.channel == 'scroll') {
            if (lastLink != e.args[0]) {
                this.props.getApp().addPage({url: e.args[0], select: false});
                lastLink = e.args[0];
                setTimeout(function() {
                    lastLink = '';
                }, 50);
    ...
    */
    onFoundInPage = (e) => {
        ...
        this.refs.findpanel.setMatches(activeMatche, matches);
    }
    /*
    * @param1 {Object} e
    */
